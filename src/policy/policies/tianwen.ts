/**
 * Tianwen Policy — LIOS v2.2 工程占位
 *
 * 当前为 LIOS v2.2 γ-4 阶段创建的占位骨架, 用于:
 * 1. 验证 "DB → registry → service" 机制对真实产品应用 tenant 工作
 * 2. 为天问 SaaS 启动后预留 tenant 槽位
 *
 * ⚠️ 真实业务规则待"天问 P0"工程阶段定义.
...
export const TianwenPolicy: TenantPolicy = Object.freeze({
  tenant_id: 'tianwen-demo',
  industry: 'tianwen',
